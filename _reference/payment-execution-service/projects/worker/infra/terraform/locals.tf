locals {
  # If you update this, ensure you also update 'worker-name-kebab-case' in '.github/workflows/workflow-get-config.yaml'.
  kubernetes_release_name = "payment-execution-worker"

  # If you update this, ensure you also update 'worker-name-kebab-case' in '.github/workflows/workflow-get-config.yaml'.
  resource_name_prefix = "payment-execution-worker"
