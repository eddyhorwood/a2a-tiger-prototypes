...
namespace XeroDotnetSampleApp.Controllers
{
    ...
    public class AuthorizationController : BaseXeroOAuth2Controller
    {
        ...
        // Locally referred Xero client object
        private readonly XeroClient _client;

        // Link the saved xeroConfig setting to thelocally referred Xero client object
        // The configuration itself was as part of the services.Configure from Startup.cs
        ...
        /// <summary>
        /// Generate random guid for site security and build the login URI to redirect user
        /// </summary>
